        ...
        {		
			...
			public void onClick(View view) {
				...
				String roll=gt.getString("roll");
        	   	...
        	   	nameValuePairs.add(new BasicNameValuePair("f2",roll));
				...
				//Toast.makeText(getBaseContext(),"Screen Size is : "+screenInches,Toast.LENGTH_SHORT).show();
        	   	...
        	   	if(isNetworkAvailable())
        	   	{
                	try
                	{
	        	        ...
	        	        HttpPost httppost = new HttpPost("http://nitrsp.byethost9.com/feedback.php");
                	 ...
                	 //parse json data
                	  try
                	  {
                		  ...
                		  {        
          	          			Toast.makeText(getApplicationContext(), "Thank you for your valueable feedback", Toast.LENGTH_SHORT).show();
                		  }
                		  else
                		  {  
